...
Pienselo por un momento. Cuando llama una función API en un servidor web normal,
...
2. Cree una función llamada `levelUp`. Esta tomará un parametro, `_zombieId`, un
