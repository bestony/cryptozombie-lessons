...
> Note: The ERC721 standard is currently a _draft_, and there is no officially
> agreed-upon implementation yet. For this tutorial we're using the current
> version from OpenZeppelin's library, but it is possible it will change in the
> future before its official release. So consider this **one** possible
> implementation, but don't take it as the official standard for ERC721 tokens.
